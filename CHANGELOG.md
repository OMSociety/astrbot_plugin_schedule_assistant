...
> 版本说明：v2.1.0~v2.5.0 的中间迭代已归档（详见下方「已归档」段与 Git 历史），
...
> 中间迭代（多平台 markdown 渲染、配置展平、Apple 日历去重、LLM 日程工具等）已归档，
> 详细内容见 Git 历史。以下为旧版 2.0.0 及更早的原始记录：

---

## [2.0.0] - 2026-04-23（旧版，已归档）
